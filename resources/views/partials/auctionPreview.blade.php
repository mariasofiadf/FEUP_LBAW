...
<div class="card flex-md-row mb-4 shadow-sm h-md-250">
  <div class="card-body d-flex flex-column align-items-start">
      <strong class="d-inline-block mb-2 text-primary text-truncate"  style="max-width: 320px;">{{ $auction->title }}</strong>
      ...
      @if (Auth::check() && Auth::id() == $auction->seller_id )        
        <a href="/auctions/{{ $auction->auction_id }}/delete" class="btn btn-outline-danger btn-sm">Delete</a>
